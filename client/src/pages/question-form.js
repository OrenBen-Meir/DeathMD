      ...
      if(this.state.response[condition].has_condition){
        responseJsx.push((
          <div className="p-3 correction-custom">
            ...
            <div className="text-white">Confidence Score: {(this.state.response[condition].confidence*100).toFixed(2)}%</div>
          </div>
        ));
      }
    }
    ...
    if(this.state.diagnosed){
      ...
      (
        <div className="text-white">
          ...
          <img className="img-fluid img-custom rounded" src="https://www.sideshow.com/wp/wp-content/uploads/2014/08/lsterminator.jpg" alt="Terminator T-400"></img>
        </div>
      );
    }
