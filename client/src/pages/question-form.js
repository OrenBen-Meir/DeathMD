...
export default class QuestionForm extends Component {
    ...
    render() {
        ...
        const retrainHeader = this.state.diagnosed?(<h3 className="mt-5">Not satisfied? Fill out what you think are the correct diagnosis</h3>): null;
        ...
        const retrained = this.state.retrain?(<div className="border-box-custom p-3">Correction sent, model will be re-trained to better predict your imminent demise!</div>):null;
